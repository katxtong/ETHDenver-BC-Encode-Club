  ...
  */
  ...
  // test that initial supply is 10000
    it("Should have 10000 as initial supply", async function(){
      ...
      expect(await volcanoCoin.returnTotalSupply()).to.equal(10000);
    });
  });
  ...
  describe("Increment initial supply of Volcano coins", function(){
    ...
    it("should increment oldValue by 1000 for newValue", async function(){
      ...
      value = Number(await volcanoCoin.returnTotalSupply());
      value += 1000;
      volcanoCoin.increaseTotalSupply();
      expect(Number(await volcanoCoin.returnTotalSupply())).to.equal(value);
    });
